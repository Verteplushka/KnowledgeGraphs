...
damage_type_mapping = {
    ...
    'молния, гром': ['Электрический'],
    'очарование': [],
    'холод, огонь, яд': ['Холодный', 'Огненный', 'Ядовитый'],
    'молния, яд; дробящий, колющий, и рубящий от немагического оружия кроме адамантиевого': ['Электрический', 'Ядовитый', 'Дробящий', 'Колющий', 'Рубящий'],
    'poison': ['Ядовитый'],
    'окаменение': [],
    'ослепление': [],
    'force, некротика, яд': ['Силовое_поле', 'Некротический', 'Ядовитый'],
